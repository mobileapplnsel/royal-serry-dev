...
class OuthModel extends CI_Model
{
    ...
    public function UpdateQuery($table, $data, $fld, $id)
    {
        $res = $this->db->update($table, $data, [$fld => $id]);
    ...
    public function selectQuery($id = '', $tbl_name = '')
    {
    ...
    public function insertQuery($tbl_name = '', $save = '')
    {
        $this->db->insert($tbl_name, $save);
        $insert_id = $this->db->insert_id();
        //echo $this->db->last_query();
        return $insert_id;
    }
    public function deleteQuery($tbl_name = '', $fld = '', $id = '')
    {
