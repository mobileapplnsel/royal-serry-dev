            ...
            <div class="modal-body">
                <div class="theme_tabs">
                   <ul class="nav nav-tabs " role="tablist">
                      <li role="presentation" ><a href="#tab1" class="active"  role="tab" data-toggle="tab">Home</a></li>
                      <li role="presentation"><a href="#tab2" class=""  role="tab" data-toggle="tab">Profile</a></li>
                   </ul>
                   <!-- Tab panes -->
