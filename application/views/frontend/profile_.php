            ...
            <div class="tab-content">
               <div id="home" class="tab-pane fade in active">
                  ...
                  <div class="form-check form-check-inline" style=" margin-left: 20px;">
                     ...
                     <label class="form-check-label" for="inlineRadio1">Normal Custome</label>
                  </div>
                  <div class="form-check form-check-inline">
                     <input class="form-check-input" type="radio" name="user_type" id="inlineRadio2" value="BU">
                     <label class="form-check-label" for="inlineRadio2">Business Custome</label>
                  </div>
                    ...
                    <?php echo form_open(base_url('credit-amount-update'), array('id' => 'CreditAmountForm', 'class' => 'CreditAmountForm')); ?>
                     <div class="row">
                        <div class="col-sm-12">
                           ...
                           <h3>Outstanding Amount($): <?php echo number_format($profile_details['credit_outstanding_amount'], 2); ?></h3>
                        </div>
                        ...
                        <div class="col-sm-6">
                           ...
                           <p><input type="radio" name="pay_type" value="cash" class="form-control info-text" checked="checked" />Cash</p>
...
$(".toggle-password").click(function() {
 ...
 $(".ChangePassword").submit('on',function(e){
            ...
            $("#element_overlap1").LoadingOverlay("show");
              ...
              dataType : "json",
              type : "post",
              data : {[csrfName]: csrfHash,New:New,Old:Old,Confirm:Confirm,},
              headers: {  'Authkey': '<?=$this->security->get_csrf_hash();?>'},
