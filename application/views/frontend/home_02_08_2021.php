                                            ...
                                            <div class="document-wrap" id="document_wrap">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-12">
                                                        <?php echo fillCombo('document_package_categories', 'cat_id', 'category_name', '', 'type= 1', 'cat_id', 'form-control form-control-new', 'document_category[]', 'document_category'); ?>
                                                    </div>
                                                    <div class="col-md-6 col-sm-12">
...
<!--<script src="<?php //echo base_url(); 
                    ?>assets/frontend/js/auto_complete2.js" type="text/javascript"></script>-->
...
<script>
    ...
    function addBtn() {
        ...
        html += '<input class="form-check-input shipment_type_option" type="radio" name="shipment_type_option' + newID + '" id="shipment_type_option_m_' + newID + '" data-newid="' + newID + '" value="1" checked>';
        ...
        html += '<input class="form-check-input shipment_type_option" type="radio" name="shipment_type_option' + newID + '" id="shipment_type_option_m_' + newID + '" data-newid="' + newID + '" value="2">';

        html += '<label class="form-check-label" for="inlineRadio2">For Package</label></div></div>';


        html += '<div class="spacer"></div><div id="show_me_document_' + newID + '"><div class="document-wrap" id="document_wrap"><h2 class="ds-title gap" style=" margin-bottom: 30px; margin-top: -15px;">Documents in your shipment.</h2><div class="spacer"></div><div class="row"><div class="col-md-6 col-sm-12">';

        html += '<?php echo fillCombo("document_package_categories", "cat_id", "category_name", "", "type= 1", "cat_id", "form-control form-control-new get_document_category", "document_category_'+newID+'[]", "document_category_'+newID+'", "", "data-newid3", "'+newID+'"); ?>';

        html += ' </div><div class="col-md-6 col-sm-12"><select class="form-control form-control-new document_item' + newID + '" id="document_item' + newID + '" name="document_item' + newID + '[]"><option>Selet Category First</option></select></div></div>  <div class="row" id="document_other_row'+newID+'" style="display:none;"><div class="col-md-6 col-sm-12"><div class="form-check form-check-inline"><input class="form-check-input" id="document_other'+newID+'" name="document_other'+newID+'[]" type="radio" value="1"><label class="form-check-label" for="document_other">Other Category</label></input></div></div><div class="col-md-6 col-sm-12"><textarea class="form-control" id="other_details_document'+newID+'" name="other_details_document'+newID+'[]" rows="2"></textarea></div></div><div class="col-sm-12"><h3 class="titelt">Value of your shipment</h3></div><div class="col-sm-6"><div class="form-group "><div class="input-group"><div class="input-group-addon no-back"><i class="fa fa fa-usd"></i></div><input class="form-control" id="value_of_shipment_document'+newID+'" name="value_of_shipment_document'+newID+'[]" type="number" /></div></div></div><div class="col-sm-6"><div class="form-check"><input class="form-check-input" type="checkbox" value="1" id="protect_shipment_document" name="protect_shipment_document'+newID+'[]"><label class="form-check-label" for="protect_shipment_document" style="top: 0px!important;">Protect your shipment</label></div></div></div> <div class="spacer"></div><div class="col-sm-12"></div><div class="spacer"></div><div class="gra-line"></div><div class="spacer"></div><div id="add_document_div'+newID+'"></div><div class="col-sm-6">&nbsp;</div><div class="row" id="document_charges_row'+newID+'" style="display:none;"><div class="col-md-4 col-sm-12"><h2 class="ds-title gap" style=" margin-bottom: 30px; ">Your Charges</h2></div><div class="col-md-8 col-sm-12"><div class="container"><div class="row"><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="road_document'+newID+'" name="charges_by'+newID+'" type="radio" value="1"><input type="hidden" name="road_document_input'+newID+'" id="road_document_input'+newID+'" value=""><label class="form-check-label" for="defaultCheck1" style="top: 0px!important;">By Road: <span id="road_document_span'+newID+'"></span></label></input></div></div><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="rail_document'+newID+'" name="charges_by'+newID+'" type="radio" value="2"><input type="hidden" name="rail_document_input'+newID+'" id="rail_document_input'+newID+'" value=""><label class="form-check-label" for="defaultCheck1" style="top: 0px!important;">By Rail: <span id="rail_document_span'+newID+'"></span></label></input></div></div></div></div><div class="container"><div class="row"><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="air_document'+newID+'" name="charges_by'+newID+'" type="radio" value="3"><input type="hidden" name="air_document_input'+newID+'" id="air_document_input'+newID+'" value=""><label class="form-check-label" for="air_document" style="top: 0px!important;">By Air: <span id="air_document_span'+newID+'"></span></label></input></div></div><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="ship_document" name="charges_by'+newID+'" type="radio" value="4"><input type="hidden" name="ship_document_input'+newID+'" id="ship_document_input'+newID+'" value=""><label class="form-check-label" for="ship_document" style="top: 0px!important;">By Ship: <span id="ship_document_span"></span></label></input></div></div></div></div></div></div></div>';

        html += '<div id="show_me_package_' + newID + '" style="display:none;"><div class="shipment-wrap"><div class="row"><div class="col-md-6 col-sm-12">';

        html += '<?php echo fillCombo("document_package_categories", "cat_id", "category_name", "", "type= 2", "cat_id", "form-control form-control-new get_package_category", "package_category_'+newID+'[]", "package_category_'+newID+'", "", "data-newid4", "'+newID+'"); ?>';

        html += '</div><div class="col-md-6 col-sm-12"><select class="form-control form-control-new" id="package_item'+newID+'" name="package_item'+newID+'[]"><option>Selet Category First</option></select></div></div>  <div class="row" id="parcel_other_row'+newID+'" style="display:none;"><div class="col-md-6 col-sm-12"><div class="form-check form-check-inline"><input class="form-check-input" id="parcel_other'+newID+'" name="parcel_other'+newID+'[]" type="radio" value="2"><label class="form-check-label" for="parcel_other">Other Category</label></input></div></div><div class="col-md-6 col-sm-12"><textarea class="form-control" id="other_details_parcel'+newID+'" name="other_details_parcel'+newID+'[]" rows="2"></textarea></div></div><div class="col-sm-6"><label for="">Describe your shipment.</label><textarea class="form-control" id="shipment_description_parcel'+newID+'" name="shipment_description_parcel'+newID+'[]" aria-label="With textarea"></textarea><div class="spacer"></div><label for="">Value of your shipment</label><div class="form-group"><div class="input-group"><div class="input-group-addon no-back"><i class="fa fa fa-usd"></i></div><input class="form-control" id="value_of_shipment_parcel" name="value_of_shipment_parcel[]" type="number" /></div></div></div><div class="col-sm-6"><label>Reference</label><input class="form-control" type="text" id="referance_parcel'+newID+'" name="referance_parcel'+newID+'[]" placeholder="Referance"><div class="spacer"></div><div class="form-check"><input class="form-check-input" type="checkbox" name="protect_parcel'+newID+'[]" id="protect_parcel'+newID+'" value="2"><label class="form-check-label" for="protect_parcel" style="top: 0px!important;">Protect your shipment</label></div></div><div class="spacer"></div><div class="col-sm-12 no-gap"><h2 class="ds-title"> Document’s packaging</h2><div class="spacer"></div> <div class="col-sm-6"><div class="spacer"></div> <label for="">Packaging type</label><select class="form-control" id=""><option>type 1</option><option>type 2</option><option>type 3</option><option>type 4</option><option>type 5</option></select><div class="spacer-gap"></div><label for="dimension">Dimension</label><div class="spacer-gap"></div><label for="length">Length</label><div class="form-group"><div class="col-sm-9 no-gap"><input class="form-control" type="text" id="length'+newID+'" name="length'+newID+'[]" placeholder="Length"></div><div class="col-sm-3 no-gap2"><select class="form-control" id="length_dimen'+newID+'" name="length_dimen'+newID+'[]"><option value="cm">cm</option><option value="inc">inc</option></select></div></div><div class="spacer"></div><label for="height">Height</label><div class="form-group"><div class="col-sm-9 no-gap"><input class="form-control" type="text" id="height'+newID+'" name="height'+newID+'[]" placeholder="Height"></div><div class="col-sm-3 no-gap2"><select class="form-control" id="height_dimen" name="height_dimen[]"><option value="cm">cm</option><option value="inc">inc</option></select></div></div><div class="spacer"></div><label for="weight">Weight</label><div class="form-group"><div class="col-sm-9 no-gap"><input class="form-control" type="text" id="weight'+newID+'" name="weight'+newID+'[]" placeholder="Weight"></div><div class="col-sm-3 no-gap2"><select class="form-control" id="weight_dimen'+newID+'" name="weight_dimen'+newID+'[]"><option value="pound">pound</option><option value="kg">kg</option></select></div></div></div><div class="col-sm-6"><label>Quantity</label><input class="form-control" type="text" id="quantity" name="quantity[]" placeholder="Quantity"><div class="spacer"></div><label for="weight">Breadth</label><div class="form-group"><div class="col-sm-9 no-gap"><input class="form-control" type="text" id="breadth'+newID+'" name="breadth'+newID+'[]" placeholder="Breadth"></div><div class="col-sm-3 no-gap2"><select class="form-control" id="breadth_dimen'+newID+'" name="breadth_dimen'+newID+'[]"><option value="cm">cm</option><option value="inc">inc</option></select></div></div></div></div></div><div class="spacer"></div><div class="col-sm-12"> </div><div class="spacer"></div><div class="gra-line"></div><div class="spacer"></div><div class="col-sm-6">&nbsp;</div><div class="row" id="parcel_charges_row'+newID+'"><div class="col-md-4 col-sm-12"><h2 class="ds-title gap" style=" margin-bottom: 30px; ">Your Charges</h2></div><div class="col-md-8 col-sm-12"><div class="container"><div class="row"><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="road_parcel'+newID+'" name="road_parcel'+newID+'" type="radio" value="1"><input type="hidden" name="road_parcel_input'+newID+'" id="road_parcel_input'+newID+'" value=""><label class="form-check-label" for="defaultCheck1" style="top: 0px!important;">By Road: <span id="road_parcel_span'+newID+'"></span></label></div></div><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="rail_parcel'+newID+'" name="rail_parcel'+newID+'" type="radio" value="2"><input type="hidden" name="rail_parcel_input'+newID+'" id="rail_parcel_input'+newID+'" value=""><label class="form-check-label" for="defaultCheck1" style="top: 0px!important;">By Rail: <span id="rail_parcel_span"></span></label></div></div></div></div><div class="container"><div class="row"><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="air_parcel" name="air_parcel" type="radio" value="3"><input type="hidden" name="air_parcel_input'+newID+'" id="air_parcel_input'+newID+'" value=""><label class="form-check-label" for="defaultCheck1" style="top: 0px!important;">By Air: <span id="air_parcel_span"></span></label></div></div><div class="col-md-6 col-sm-4"><div class="form-check"><input class="form-check-input rate_checkbox" id="ship_parcel'+newID+'" name="ship_parcel'+newID+'" type="radio" value="4"><input type="hidden" name="ship_parcel_input'+newID+'" id="ship_parcel_input'+newID+'" value=""><label class="form-check-label" for="defaultCheck1" style="top: 0px!important;">By Ship: <span id="ship_parcel_span'+newID+'"></span></label></div></div></div></div></div></div></div>';
