    ...
    $(document).ready(function() {
        ...
        $(".next").click(function() {
            ...
            if (nextbtnval == 'change_location') {
                ...
                if (firstname != '' && lastname != '' && address_from != '' && country != '' && state != '' && city != '' && zip != '' && email != '' && telephone != '' && firstname_to != '' && lastname_to != '' && address_to != '' && zip_to != '' && email_to != '' && telephone_to != '' && country_to != '' && state_to != '' && city_to != '' && zip_from == '' && zip_to_val == '') {
                    gotonext = 1;
                    //$('#second_step').prop('disabled', false);
                } else {
                    gotonext = 2;
