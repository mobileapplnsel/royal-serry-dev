                                ...
                                <div class="form-card">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div id="div_zip"></div>
                                            <div class="zip_popup" style="display: none;" data-zip=""><a class="getintouch-pop" href="javascript:void(0);" style="color:#016c1c!important;" data-zip-type="zip">Click here</a> to get in touch!</div>
                                 ...
                                 <label class="form-check-label" for="copy_from">Copy From Address</label>-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="zip_to_popup" style="display: none;" data-zip-to=""><a class="getintouch-pop" href="javascript:void(0);" style="color:#016c1c!important;" data-zip-type="zip_to">Click here</a> to get in touch!</div>
    ...
    $(document).ready(function() {
        ...
        $(".next").click(function() {
            ...
            if (nextbtnval == 'change_location') {
                ...
                if (firstname != '' && lastname != '' && address_from != '' && country != '' && state != '' && city != '' && zip != '' && email != '' && telephone != '' && firstname_to != '' && lastname_to != '' && address_to != '' && zip_to != '' && email_to != '' && validateEmail(email_to) && telephone_to != '' && country_to != '' && state_to != '' && city_to != '' && zip_from == '' && zip_to_val == '') {
                    gotonext = 1;
                    //$('#second_step').prop('disabled', false);
                } else {
                    gotonext = 2;
        ...
        $('.create-order').on('click', function() {
            ...
            if (charges_sum > 0) {
                ...
                toastr.error('<span style="color:#fff;">Rate not found! Please choose the right combination.</span>');
            }
