                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-12" style="text-align: center;">
                                       <div class="form-check form-check-inline">
                                          ...
                                          <label class="form-check-label" for="location_type1">Domestic</label>
                                       </div>
                                       <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="location_type" id="location_type2" value="2">
                                          <label class="form-check-label" for="location_type2">International</label>
                                       </div>
                                 ...
                                 <div class="form-card">
                                    <div class="row">
                                       <div class="col-5">
                                          ...
                                          <button type="button" class="Modal-st" data-toggle="modal" data-target="#myModal">
                                    ...
                                    <div id="details_of_pack">
                                       <!--++++++++++++++++++++++++++top-toggle-redio+++++++-->
                                       <div class="form-check form-check-inline" id="document_option">
                                       ...
                                       <div id="show-me">
                                          ...
                                          <!--=====================-->
                                          <div class="spacer"></div>
                                          <div class="col-sm-12"><a href="javascript:void(0);" class="add-more" id="add_more_doc">+ Add More</a></div>
                                          <div class="spacer"></div>                                          
                                       ...
                                       <div id="show-me-three" style="display:none;">
                                          <div class="shipment-wrap">
                                             ...
                                             <div class="col-sm-6">
                                                ...
                                                <input class="form-control" type="text" id="referance_parcel" name="referance_parcel[]" placeholder="Referance">
                                                <div class="spacer"></div>
                                                <div class="form-check">
                                          ...
                                          <!--=====================-->
                                          <div class="spacer"></div>
                                          <div class="col-sm-12"><a href="#" class="add-more">+ Add More</a> </div>
                                          <div class="spacer"></div>
                                          <div class="gra-line"></div>
                                          <!--+++++++++++++++++++++++++++--------+++++++++++++-->
                                          <!--+++++++++++++++++++++++++++sec+++++++++++++-->
   ...
   $('#document_category').on('change', function() {
       ...
       if (categoryID) {
           $.ajax({
               ...
               data: {[csrfName]: csrfHash,category_id: categoryID},
               success: function(data) {
...
$(document).on('change','.rate_checkbox',function(){
   if($(this).val() > 0){
      ...
      $.ajax({
               ...
               data: {[csrfName]: csrfHash,ship_cat_id: ship_cat_id,ship_subcat_id:ship_subcat_id,rate_type:rate_type,location_from:location_from,location_to:location_to},
               success: function(data) {                  
                  var string1 = JSON.stringify(data);                   
                  var dataObj =JSON.parse(string1);
                  $(dataObj).each(function() {
