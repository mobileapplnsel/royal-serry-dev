                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div id="details_of_pack">
                                        ...
                                        <div class="spacer"></div>
                                           ...
                                           <div class="new-background">
                                            <div class="document-wrap" id="document_wrap">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-check" style="padding-top: 5px!important;">
                                        ...
                                        <!--+++++++++++++++++++++++++++++++for-documents-->
                                        <!--+++++++++++++++++++++++++++++++For Package-->
                                        <div style="width: 100%; height: 15px; display: block; clear: both;"></div>
                                        <div id="show-me-three" style="display:none;">
                                            <div class="shipment-wrap">
                                                ...
                                                <!--+++++++++++++++++++++++++++++++++++++++++++++++++new-back++++++-->
                                                        <div class="new-background">
                                                        <h2 class="ds-title gap" style="margin: 15px 0 0 9px;">Document & Packaging</h2>
  ...
  <!--++++++++++11111111111111111111+++++++++++-->
                                                   ...
                                                   <select class="form-control" id="">
                                                      ...
                                                      <option>type 5</option>
                                                        ...
                                                        <label for="length">Packaging type</label>
                                                      <select class="form-control form-control-new" id="package_type" name="package_type[]">
                                                    ...
                                                    <div class="spacer"></div>
                                                    <h2 class="ds-title gap" style="margin: -21px 0 15px 9px;">Dimension</h2>
                                                    <div class="spacer"></div>
       ...
       <!--+++++++++++++++++++++++++++++++++++++++++++++++++new-back-end++++++-->   
                        ...
                        <div class="spacer-gap"></div>                        
                     <div class="col-sm-12 no-gap"><button type="button" class="btn btn-success" onclick="addBtn()"> Add More </button>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-danger" onclick="removeBtn('5353')"> Remove </button></div>                           
                        ...
                        <div class="spacer-gap"></div>                        
                                           ...
                                           <div class="new-background">
                                            ...
                                            <div class="row" id="parcel_charges_row">
                                                <div class="col-md-12 col-sm-12">
                                                    <h2 class="ds-title gap">Your Charges</h2>
                                                </div>
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="container">
                                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-4">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="road_radio" style="top: 0px!important;">By Road: <span id="road_span"></span></label>
                                                        </input>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-4">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="rail_dadio" style="top: 0px!important;">By Rail: <span id="rail_span"></span></label>
                                                        </input>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-4">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="air_radio" style="top: 0px!important;">By Air: <span id="air_span"></span></label>
                                                        </input>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-4">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="ship_radio" style="top: 0px!important;">By Ship: <span id="ship_span"></span></label>
                                                        </input>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <input type="button" name="next" data-next="form_4" class="next action-button submit create-order" value="Place Order" />
...
<script>
        ...
        $(".next").click(function() {
            ...
            if (nextbtnval == 'change_location') {
                ...
                if (address2 == '') {
                    ...
                    $(".address2_from_err").html('<font color="red">Pleae enter your address.</font>');
    ...
    function addBtn() {
        ...
        html += '<input class="form-check-input new-ids" type="text" name="ids[]" value="' + newID + '" >';
                        ...
                        $(dataObj).each(function() {
                            ...
                            if (ship_cat_id == 1) {
                                if (this.ship_mode_id == 1) {
                                    ...
                                    $('#road_input').val(this.rate + parseFloat(road_input));
                                    $('#road_span').text(this.rate + parseFloat(road_input));
                                    ...
                                    $('#rail_input').val(this.rate);
                                    $('#rail_span').text(this.rate);
                                    ...
                                    $('#air_input').val(this.rate);
                                    $('#air_span').text(this.rate);
                                    ...
                                    $('#ship_input').val(this.rate);
                                    $('#ship_span').text(this.rate);
                                ...
                                if (this.ship_mode_id == 1) {
                                    ...
                                    $('#road_input').val(this.rate);
                                    $('#road_span').text(this.rate);
    ...
    function ratecheckbox1(charges_mode) {
        var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>',
            csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
        var ship_cat_id = $('input[name="shipment_type_option"]:checked').val();
        //var rate_doc_per = $('.rate_checkbox:checked').attr('name');
