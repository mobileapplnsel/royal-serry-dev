    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="col-md-11">
                    <h2></h2>
                    <form method="POST" action="<?= base_url('admin/insertVideoTag') ?>" enctype="multipart/form-data">
                        <div class="form-group col-md-6 col-md-offset-3"></div>
                        <div class="form-group col-md-6">
                            <label for="email">Tag Name : </label>
                            <input type="text" class="form-control" placeholder="Tag Name" name="tag_name" value="" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12" style="margin-bottom:15px">
                            <button type="submit" class="btn btn-success">Add Video Tag</button>
                        </div>
                    </form>
