                ...
                <div class="col-md-11">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-6">
                            <label for="email">Document Name<span>*</span> : </label>
                            <input type="text" class="form-control" placeholder="Document Name" name="name" maxlength="20" onKeyUp="this.value=this.value.replace(/[^A-z_ ]/g,'');" value="<?= $editDocument[0]->name ?>" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="parent">Document Category<span>*</span> : </label>                        
                        ...
                        <div class="form-group col-md-6">
                            <label for="email">Document Description<span>*</span> : </label>
