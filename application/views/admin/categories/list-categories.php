    ...
    <div class="wrapper">
        ...
        <?php } ?>
            <section class="content-header">
                <h1>
                    Documents & Package Category List
                </h1>
                <ol class="breadcrumb">
                    <li><a href="<?= base_url('admin/addcategory') ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i>Add New Category</a></li>
                    <li><a href="<?= base_url('admin/categories-list') ?>"><i class="fa fa-dashboard"></i>Home</a></li>
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><ul class="admin-action btn btn-default" style="list-style:none;">
                                                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="true"> Action <span class="caret"></span> </a>
                                                  <ul class="dropdown-menu dropdown-menu-left">
                                                    <li role="presentation"> <a role="button" href="<?= base_url('admin/editcategory/')?><?= $categories->cat_id ?>" class="btn" style="text-align: left"><i class="fa fa-pencil text-blue"></i> Edit</a> </li>
                                                   
                                                    <li class="divider" role="presentation"></li>
                                                    <li role="presentation"> <a data-toggle="modal" data-target="#categoryDeleteModal" data-category-id="<?= $categories->cat_id ?>" class="btn" style="text-align: left"><i class="fa fa-trash text-red"></i> Delete</a> </li>
                                                  </ul>
                                                </li>
                                              </ul></td>
                                            <td><?= $categories->category_name ?></td>
                                            <td><?= $categories->parent_cat_name ?></td>
                                            <td><?php if($categories->type=='1'){echo 'Document';} else {echo 'Package';}?></td>
                                            ...
                                            <!--<td>
                                                <a href='<?= base_url('admin/editcategory/')?><?= $categories->cat_id ?>'>
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td><a data-toggle="modal" data-target="#categoryDeleteModal" data-category-id="<?= $categories->cat_id ?>" style="cursor:pointer;"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>-->
                                        </tr>
                                        <?php 
                                            }                                            
                                            else:
