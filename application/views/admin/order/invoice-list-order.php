        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Invoice Order List</li>
                </ol>
            </section>
            <section class="content-header">
                <div class="row">
                    <div class="col-xs-12">    
                        <div class="box">
                            <div class="box-body">   
                                <?php echo form_open(base_url('admin/invoice-list'), array('id' => 'searchF', 'class' => 'form-inline','method'=>'POST', 'enctype' => 'multipart/form-data')); ?>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">                                        
                                        ...
                                        <a href="<?php echo base_url('admin/invoice-list'); ?>" class="btn btn-success">Reset</a>                                        
                                    </div>                                    
                                </div>                                
                                <?php echo form_close(); ?>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Invoice Order List</h3>
                            </div>
                            <div class="box-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                            ...
                                            <td><ul class="admin-action btn btn-default" style="list-style:none;">
                                                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="true"> Action <span class="caret"></span> </a>
                                                  <ul class="dropdown-menu dropdown-menu-left">
                                                    <li role="presentation"> <a role="button" href="<?= base_url('admin/print-invoice/')?><?= $order->id ?>" class="btn" style="text-align: left" target="_blank"><i class="fa fa-eye text-blue"></i> View Invoice</a> </li>
                                        ...
                                        <?php 
                                            ...
                                            echo '<td rowspan="6">No Invoice Order Found</td>';
                                            endif;
                                        ?>
                                    </tbody>
                                </table>
