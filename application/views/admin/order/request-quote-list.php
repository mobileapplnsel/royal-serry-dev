<?php
//echo '<pre>'; print_r($requestQuoteList);echo '</pre>'; //die;
            ...
            <section class="content-header">
                <div class="row">
                    <div class="col-xs-12">    
                        <div class="box">
                            <div class="box-body">   
                                <?php echo form_open(base_url('admin/quote-request-list'), array('id' => 'searchF', 'class' => 'form-inline','method'=>'POST', 'enctype' => 'multipart/form-data')); ?>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">                                        
                                        ...
                                        <a href="<?php echo base_url('admin/quote-request-list'); ?>" class="btn btn-success">Reset</a>                                       
                                    </div>                                    
                                </div>                                
                                <?php echo form_close(); ?>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Request Quotation List</h3>
                            </div>
                            <div class="box-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            if(!empty($requestQuoteList)):
                                            foreach($requestQuoteList as $quotation){
                                        ?>
                                        <tr>
                                            <td><?= $quotation->id ?></td>
                                            <td><ul class="admin-action btn btn-default" style="list-style:none;">
                                                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="true"> Action <span class="caret"></span> </a>
                                                  <ul class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    <li role="presentation"> <a role="button" href="<?= base_url('admin/createQuote/')?><?= $quotation->id ?>" class="btn" style="text-align: left"><i class="fa fa-pencil-square-o text-blue"></i> Edit Quotation</a> </li>
                                                    <?php if($quotation->quote_type==0) {?>
                                                    <li class="divider" role="presentation"></li>
                                                    <li role="presentation"> <a role="button" href="<?= base_url('admin/pdboyquotereqcompleted/')?><?= $quotation->id ?>/1" class="btn" style="text-align: left"><i class="fa fa-plus text-blue"></i>Mark as completed</a> </li>
                                                    <?php }?>
                                                  </ul>
                                                </li>
                                              </ul></td>
