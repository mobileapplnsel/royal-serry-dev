        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Pickup Image Upload</li>
                </ol>
            </section>
            <h2></h2>
            <!-- DataTables Example -->
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Select Pickup Images</h3>
                            </div>
                                    ...
                                    <tbody> 
                                        ...
                                        ?>
                                            <tr id="tr_<?php echo $value->id; ?>">
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('uploads/pick_up/'); ?><?php echo $value->image; ?>" download>
                                                    <img src="<?php echo base_url('uploads/pick_up/'); ?><?php echo $value->image; ?>" class="img-thumbnail" width="100px"></a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a data-toggle="modal" data-target="#pickupimgDeleteModal" data-pickupimg-id="<?= $value->id ?>" class="btn text-danger" style="text-align: left"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>                                       
                                        <?php } } else {?>
                                            <tr>
