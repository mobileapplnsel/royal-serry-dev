                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="custom-file-input" name="heading2" value="<?php echo $editDocument[0]->heading2; ?>" required>
                            </div>


                            <div class="form-group col-md-6">
                                <label for="heading3">Heading 3 :</label>
                                <input type="text" class="custom-file-input" name="heading3" value="<?php echo $editDocument[0]->heading3; ?>" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="sub_heading">Sub Heading :</label>
                                <input type="text" class="custom-file-input" name="sub_heading" value="<?php echo $editDocument[0]->sub_heading; ?>" required>
                            </div>
