    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="col-md-11">
                    <h2></h2>
                    <form method="POST" action="<?= base_url('subscription/insertSubscription') ?>" enctype="multipart/form-data">
                        <div class="form-group col-md-6">
                            ...
                            <label>
                                Yes :
                                <input type="radio" name="is_popular" class="minimal-red" value="1"/>
                            </label> &nbsp; &nbsp;
                            <label>
                                No :
                                <input type="radio" name="is_popular" class="minimal-red" value="0"/>
                            </label> &nbsp; &nbsp;                            
                        </div>
						<div class="form-group col-md-6 col-md-offset-3"></div>
                        <div class="form-group col-md-6">
                            <label for="email">Subscription Name : </label>
                            <input type="text" class="form-control" placeholder="Subscription Name" name="subscription_name" value="" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" placeholder="Subscription Duration" name="subscription_validity" min="1" value="" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="email">Subscription Price : </label>
                            <input type="number" class="form-control" placeholder="Subscription Pricing" name="subscription_price" min="1" value="" required>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="email">Subscription Description : </label>
                            <textarea rows="10" cols="60" class="form-control" name="subscription_brief" style="resize:none;" required></textarea>
                        </div>
                        <!-- <div class="form-group col-md-6">
